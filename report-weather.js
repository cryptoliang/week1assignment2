...
const weatherContract = new ethers.Contract(WEATHER_CONTRACT_ADDRESS, weatherAbi, wallet)
...
async function reportWeathers(batchId, weathers) {
    console.log(`Reporting weathers to contract address: ${WEATHER_CONTRACT_ADDRESS}, batchId: ${batchId}`)
...
async function readWeathersFromContract(batchId, cities) {
    console.log(`Reading weathers from contract address: ${WEATHER_CONTRACT_ADDRESS}, batchId: ${batchId}`)
